...
D_har_major = map(lambda x: x+2, C_major)
Eb_har_major = map(lambda x: x+3, C_major)
E_har_major = map(lambda x: x+4, C_major)
F_har_major = map(lambda x: x+5, C_major)
Gb_har_major = map(lambda x: x+6, C_major)
G_har_major = map(lambda x: x+7, C_major)
Ab_har_major = map(lambda x: x+8, C_major)
A_har_major = map(lambda x: x+9, C_major)
Bb_har_major = map(lambda x: x+10, C_major)
B_har_major = map(lambda x: x+11, C_major)
