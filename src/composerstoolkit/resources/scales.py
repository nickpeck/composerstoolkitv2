...
Db_har_minor = map(lambda x: x+1, C_har_minor)
D_har_minor = map(lambda x: x+2, C_har_minor)
Eb_har_minor = map(lambda x: x+3, C_har_minor)
E_har_minor = map(lambda x: x+4, C_har_minor)
F_har_minor = map(lambda x: x+5, C_har_minor)
Gb_har_minor = map(lambda x: x+6, C_har_minor)
G_har_minor = map(lambda x: x+7, C_har_minor)
Ab_har_minor = map(lambda x: x+8, C_har_minor)
A_har_minor = map(lambda x: x+9, C_har_minor)
Bb_har_minor = map(lambda x: x+10, C_har_minor)
B_har_minor = map(lambda x: x+11, C_har_minor)

C_har_major = [0] + sorted(filter(lambda x: (x % 12) in \
    HAR_MAJOR_SCALE_PITCH_CLASSES , range(1, NOTE_MAX)))
Db_har_major = map(lambda x: x+1, C_har_major)
D_har_major = map(lambda x: x+2, C_har_major)
Eb_har_major = map(lambda x: x+3, C_har_major)
E_har_major = map(lambda x: x+4, C_har_major)
F_har_major = map(lambda x: x+5, C_har_major)
Gb_har_major = map(lambda x: x+6, C_har_major)
G_har_major = map(lambda x: x+7, C_har_major)
Ab_har_major = map(lambda x: x+8, C_har_major)
A_har_major = map(lambda x: x+9, C_har_major)
Bb_har_major = map(lambda x: x+10, C_har_major)
B_har_major = map(lambda x: x+11, C_har_major)
